...
export const GUIDE_METADATA = {
  ...
  strengthWorkout: { title: 'Want help with your first workout?', duration: '25 sec', body: 'We’ll point out the controls that help you stay in control.' },
  strengthSummary: { title: 'Want to understand your workout summary?', duration: '15 sec', body: 'We’ll show you the useful parts of your session record.' },
