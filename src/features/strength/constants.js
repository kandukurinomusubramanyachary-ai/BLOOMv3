...
const STRENGTH_COPY = Object.freeze({
  ...
  secureCamera: 'Camera tracking needs a secure HTTPS link on your phone. A plain http:// computer address cannot use the camera. Open Bloom over HTTPS, or continue guided without a camera.',
  browserUnsupported: 'This browser cannot provide camera access. Open Bloom in Safari or Chrome, or continue guided.',
  cameraMissing: 'No camera was found. Connect a camera, or continue guided without one.',
  cameraTimeout: 'The camera did not start in time. Check the browser permission prompt, then try again or continue guided.',
  ...
  transitionBreath: 'Nice work. Catch your breath before the next movement.',
  transitionFindYou: 'Let me find you before we begin.',
  transitionSettingUp: 'Setting up for the next movement…',
  manualPause: 'Paused. Take the time you need.',
  pageHidden: 'The session paused while this page was hidden.',
  backgroundPause: 'Paused — your reps are safe.',
  resumePrompt: 'Ready to continue?',
  resumeHelp: 'Your reps are safe. Pick up where you left off.',
  resume: 'Resume',
