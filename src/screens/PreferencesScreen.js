...
const styles = createThemedStyles({
  ...
  fields: { gap: 14 },
  field: { gap: 7 },
  label: { ...TYPOGRAPHY.supporting, fontWeight: '600', color: COLORS.ink },
  ...
  modeCopy: { flex: 1 },
  modeTitle: { ...TYPOGRAPHY.componentTitle, color: COLORS.ink },
  modeDescription: { marginTop: 3, ...TYPOGRAPHY.caption, color: COLORS.muted },
  ...
  groupLabel: { marginBottom: 10, ...TYPOGRAPHY.supporting, fontWeight: '700', color: COLORS.body },
  ...
  toggleCopy: { flex: 1 },
  toggleTitle: { ...TYPOGRAPHY.supporting, fontWeight: '600', color: COLORS.ink },
  toggleDescription: { marginTop: 2, ...TYPOGRAPHY.caption, color: COLORS.muted },
  ...
  estimateNote: { marginTop: 12, ...TYPOGRAPHY.caption, color: COLORS.muted },
