...
const styles = createThemedStyles({
  ...
  scrollContent: { flexGrow: 1, paddingBottom: 40 }, content: { width: '100%', maxWidth: 600, alignSelf: 'center', paddingHorizontal: 20, paddingTop: 24 }, flex: { flex: 1, minWidth: 0 },
  ...
  sosButton: { minHeight: 58, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 16, paddingLeft: 20, paddingRight: 7, borderRadius: 14, backgroundColor: COLORS.brand }, sosButtonText: { fontSize: 17, lineHeight: 22, fontWeight: '700', color: COLORS.onBrand }, sosArrow: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.white }, sosPromise: { ...TYPOGRAPHY.caption, color: COLORS.body, textAlign: 'center', marginTop: 10 },
  section: { marginBottom: 32 }, sectionHeader: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-end', gap: 14, marginBottom: 12 }, sectionTitle: { ...TYPOGRAPHY.sectionTitle, color: COLORS.ink }, sectionSubtitle: { ...TYPOGRAPHY.supporting, color: COLORS.muted, marginTop: 3 },
  ...
  waterRow: { flexDirection: 'row', alignItems: 'center', gap: 10, minHeight: 82, paddingVertical: 14, borderTopWidth: 1, borderBottomWidth: 1, borderColor: COLORS.hairline }, counterButton: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: COLORS.surfaceSoft }, waterCount: { minWidth: 24, textAlign: 'center', fontSize: 18, lineHeight: 24, fontWeight: '700', color: COLORS.ink, fontVariant: ['tabular-nums'] },
